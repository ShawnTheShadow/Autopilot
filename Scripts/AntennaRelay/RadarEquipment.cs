	...
	public sealed class RadarEquipment : IComparable<RadarEquipment>
	{
		...
		private void UpdateElectricityConsumption()
		{
			...
			if (MySandboxGame.Static.UpdateThread == Thread.CurrentThread)
				...
				MySandboxGame.Static.Invoke(UpdateElectricityConsumption, "Electric");
		}
		...
		private void Update()
		{
			if (_beaconLight != null && _beaconLight.Intensity != 0)
			{
				...
				MySandboxGame.Static.Invoke(_beaconLight.UpdateLight, "UpdateLight");
			}
			...
			if (_dirtyCustomInfo)
			{
				...
				if (term != null)
					MySandboxGame.Static.Invoke(term.UpdateCustomInfo, "CustomInfo");
			}
		}
